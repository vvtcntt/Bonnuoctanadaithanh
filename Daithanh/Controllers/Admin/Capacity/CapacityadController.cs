...
namespace Daithanh.Controllers.Admin.Capacity
{
    public class CapacityadController : Controller
    {
        ...
        // GET: Capacityad
         ...
         public ActionResult Create(tblCapacity tblcapacity, FormCollection collection)
         {
             ...
             clsSitemap.CreateSitemap("0/"+StringClass.NameToTag(tblcapacity.Name)+"" , id, "Capacity"); 
         ...
         public ActionResult Edit(tblCapacity tblcapacity, int id, FormCollection collection)
         {
             if (ModelState.IsValid)
             {
                 ...
                 db.SaveChanges();
                 clsSitemap.UpdateSitemap("0/"+StringClass.NameToTag(tblcapacity.Name) , id.ToString(), "Capacity"); 
                 #region[Updatehistory]
