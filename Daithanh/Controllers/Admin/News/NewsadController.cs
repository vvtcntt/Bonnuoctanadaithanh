...
namespace Daithanh.Controllers.Admin.News
{
    public class NewsadController : Controller
    {
        ...
        public ActionResult Create(tblNew tblnews, FormCollection Collection, string id, int[] MutilMenu)
        {
            ...
            if (nidCate != "")
            {
                ...
                clsSitemap.CreateSitemap("/" + tblnews.Tag+".html", listprro[0].id.ToString(), "News");
                ...
                StringClass.CreateTagNews(idNews, tblnews.Keyword);
                if (MutilMenu != null)
                {
        ...
        public ActionResult Edit(tblNew tblnews, FormCollection collection, int? id, int[] MutilMenu)
        {
            ...
            if (ModelState.IsValid)
            {
                if (collection["drMenu"] != "" || collection["drMenu"] != null)
                {
                    ...
                    {
                        tblnews.Tag = StringClass.NameToTag(tblnews.Name);
                        clsSitemap.UpdateSitemap("/" + StringClass.NameToTag(tblnews.Name)+".html", id.ToString(), "News");
                    ...
                    {
                        int idTag = listNewsTag[i].id;
                        tblNewsTag tbltagnews = db.tblNewsTags.Find(idTag);
                        db.tblNewsTags.Remove(tbltagnews);
                        db.SaveChanges();
                    }
                    StringClass.CreateTagNews(id.Value, tblnews.Keyword);
                }
                if (collection["btnSave"] != null)
                {
