...
{
    public partial class DaithanhContext : DbContext
    {
        static DaithanhContext()
        {
            Database.SetInitializer<DaithanhContext>(null);
        }

        public DaithanhContext()
            : base("Name=DaithanhContext")
        {
        }
        ...
        public DbSet<tblNewsTag> tblNewsTags { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new tblNewsTagMap());
